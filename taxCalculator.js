...
function main() {
  var question1 = document.getElementById("salaryQuestion").value;
  var question2 = document.getElementById("dependentsQuestion1").value;
  var question3 = document.getElementById("dependentsQuestion2").value;
  ...
  var a = deductions(question1);
  var b = bracketChoice(a);
  var c = taxCredits(b, question2, question3);
  console.log(c);
  document.getElementById("placeholder").innerHTML = c;
}
